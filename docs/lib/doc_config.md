...
LH_TAR_EXCLUDES_DEFAULT=""
LH_DEBUG_LOG_LIMIT_DEFAULT="10"
LH_KEEP_SOURCE_SNAPSHOTS_DEFAULT="prompt"
LH_SOURCE_SNAPSHOT_DIR_DEFAULT="/.snapshots_lh"
LH_SOURCE_SNAPSHOT_RETENTION_DEFAULT="1"
LH_BACKUP_SUBVOLUMES_DEFAULT="@ @home"
...
```bash
CFG_LH_BACKUP_ROOT="/mnt/backup_drive/"
