...
if [[ "${BASH_SOURCE[0]}" == "${0}" ]]; then
    ...
    lh_begin_module_session "mod_backup_tar" "$(lh_msg 'BACKUP_TAR_HEADER')" "$(lh_msg 'LIB_SESSION_ACTIVITY_PREP' "$(lh_msg 'BACKUP_TAR_HEADER')")" "${LH_BLOCK_FILESYSTEM_WRITE},${LH_BLOCK_SYSTEM_CRITICAL}" "HIGH"
