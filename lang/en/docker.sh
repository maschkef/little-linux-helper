...
MSG_EN[DOCKER_CONFIG_MENU_CHANGE_MODE]="Change check mode (normal/strict)"
...
MSG_EN[DOCKER_CONFIG_MODE_NORMAL]="normal: Standard security checks"
MSG_EN[DOCKER_CONFIG_MODE_STRICT]="strict: Extended and stricter checks"
