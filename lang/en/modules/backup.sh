...
MSG_EN[RESTORE_WARNING_CRITICAL_HEADING]="CRITICAL WARNING"
...
# Post-restore verification and step-by-step guidance
MSG_EN[RESTORE_STEP]="Step"
MSG_EN[RESTORE_CHECK_HARDWARE]="Hardware Check"
MSG_EN[RESTORE_HARDWARE_CHECK_INFO]="Checking if restoring to different hardware"
MSG_EN[RESTORE_DIFFERENT_HARDWARE_Q]="Are you restoring to different hardware or disk?"
MSG_EN[RESTORE_SAME_HARDWARE]="Same hardware detected"
MSG_EN[RESTORE_DIFFERENT_HARDWARE_DETECTED]="Different hardware detected - additional configuration needed"
MSG_EN[RESTORE_NO_MANUAL_STEPS]="No manual configuration steps required"
MSG_EN[RESTORE_VERIFY_FSTAB]="Verify /etc/fstab"
MSG_EN[RESTORE_FSTAB_NOT_FOUND]="fstab file not found at: %s"
MSG_EN[RESTORE_SHOWING_CURRENT_UUIDS]="Showing current disk UUIDs"
MSG_EN[RESTORE_CURRENT_DISK_UUIDS]="Current Disk UUIDs"
MSG_EN[RESTORE_CURRENT_FSTAB]="Current /etc/fstab content"
MSG_EN[RESTORE_EDIT_FSTAB_Q]="Would you like to edit /etc/fstab to update UUIDs?"
MSG_EN[RESTORE_OPENING_EDITOR]="Opening editor: %s"
MSG_EN[RESTORE_FSTAB_UPDATED]="fstab updated successfully"
MSG_EN[RESTORE_FSTAB_SKIPPED]="fstab editing skipped"
MSG_EN[RESTORE_UPDATE_GRUB_CONFIG]="Update GRUB Configuration"
MSG_EN[RESTORE_GRUB_UPDATE_INFO]="Updating GRUB configuration with new settings"
MSG_EN[RESTORE_UPDATE_GRUB_NOW_Q]="Would you like to update GRUB configuration now?"
MSG_EN[RESTORE_UPDATING_GRUB]="Updating GRUB configuration..."
MSG_EN[RESTORE_GRUB_UPDATED]="GRUB configuration updated successfully"
MSG_EN[RESTORE_GRUB_UPDATE_FAILED]="GRUB configuration update failed"
MSG_EN[RESTORE_MANUAL_GRUB_CMD]="Run this command manually:"
MSG_EN[RESTORE_MOUNT_NOT_READY]="Mount points not ready for chroot"
MSG_EN[RESTORE_MANUAL_MOUNT_GRUB]="Mount required filesystems first:"
MSG_EN[RESTORE_GRUB_UPDATE_SKIPPED]="GRUB update skipped"
MSG_EN[RESTORE_BOOTLOADER_CONFIG]="Bootloader Configuration"
MSG_EN[RESTORE_BOOTLOADER_CONFIG_INFO]="Configuring bootloader for restored system"
MSG_EN[RESTORE_RUN_BOOTLOADER_CONFIG_Q]="Would you like to configure bootloader now?"
MSG_EN[RESTORE_BOOTLOADER_CONFIGURED]="Bootloader configured successfully"
MSG_EN[RESTORE_BOOTLOADER_CONFIG_INCOMPLETE]="Bootloader configuration incomplete"
MSG_EN[RESTORE_BOOTLOADER_CONFIG_SKIPPED]="Bootloader configuration skipped"
MSG_EN[RESTORE_BOOTLOADER_DETECTION_FAILED]="Bootloader detection failed"
MSG_EN[RESTORE_VERIFICATION_COMPLETE]="Verification Complete"
MSG_EN[RESTORE_NEXT_STEPS]="Next Steps"
MSG_EN[RESTORE_NEXT_UNMOUNT]="Unmount the restored filesystem"
MSG_EN[RESTORE_NEXT_REBOOT]="Reboot the system"
MSG_EN[RESTORE_NEXT_TEST]="Test that the system boots correctly"
MSG_EN[RESTORE_TARGET_NOT_SET]="Target root path not set"
MSG_EN[RESTORE_ENTER_TARGET_ROOT]="Enter target root path (e.g., /mnt)"
MSG_EN[RESTORE_INVALID_TARGET]="Invalid target root path"
