...
MSG_EN[ENERGY_CONFIRM_REPLACE_ACTIVE_INHIBIT]="An active sleep inhibit already exists. Replace it with the new settings?"
...
MSG_EN[ENERGY_INFO_ALREADY_ACTIVE_INHIBIT]="A sleep inhibit is already active for this module."
...
MSG_EN[ENERGY_STATUS_TIMER_REMAINING]="Remaining timer: %s"
