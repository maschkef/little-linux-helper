...
MSG_DE[ENERGY_CONFIRM_REPLACE_ACTIVE_INHIBIT]="Es ist bereits eine aktive Standby-Sperre vorhanden. Möchten Sie diese durch die neuen Einstellungen ersetzen?"
...
MSG_DE[ENERGY_INFO_ALREADY_ACTIVE_INHIBIT]="Für dieses Modul ist bereits eine Standby-Sperre aktiv."
...
MSG_DE[ENERGY_STATUS_TIMER_REMAINING]="Verbleibender Timer: %s"
