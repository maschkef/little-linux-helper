...
MSG_DE[DOCKER_CONFIG_MENU_CHANGE_MODE]="Prüfmodus ändern (normal/strict)"
...
MSG_DE[DOCKER_CONFIG_MODE_NORMAL]="normal: Standard-Sicherheitsprüfungen"
MSG_DE[DOCKER_CONFIG_MODE_STRICT]="strict: Erweiterte und strengere Prüfungen"
